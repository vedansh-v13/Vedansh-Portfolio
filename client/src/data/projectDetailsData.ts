...
export const projectDetailsData: Record<string, ProjectDetails> = {
  "tata-capital-wealth": {
    ...
    description: "I redesigned wealth management experiences focused on clarity, trust, and efficiency — simplifying investment workflows, improving information architecture, and establishing scalable UI patterns for a premium wealth platform.",
    coverImage: "/images/tata-portfolio-dashboard.png",
    date: "2025",
    metrics: [],
    screenshots: [
      { url: "/images/tata-portfolio-dashboard.png", alt: "Portfolio Dashboard", caption: "Portfolio dashboard with investment overview, RM updates, and portfolio insights", type: "mobile" },
      { url: "/images/tata-account-menu.png", alt: "Account Navigation", caption: "Account menu with profile, risk profile, and structured navigation hierarchy", type: "mobile" },
      { url: "/images/tata-investment-overview.png", alt: "Investment Overview", caption: "Investment overview with product exploration and educational content", type: "mobile" },
      { url: "/images/tata-mutual-funds.png", alt: "Mutual Funds Hub", caption: "Mutual funds hub with portfolio summary, collections, and fund discovery", type: "mobile" },
      { url: "/images/tata-fund-details.png", alt: "Fund Details", caption: "Fund details with performance charts, risk meter, and peer comparison", type: "mobile" },
      { url: "/images/tata-investment-details.png", alt: "Investment Details", caption: "Investment details with holdings overview, quick actions, and transaction history", type: "mobile" },
      { url: "/images/tata-portfolio-analysis.png", alt: "Portfolio Analysis", caption: "Portfolio analysis with performance comparison, fund health, and asset allocation", type: "mobile" },
      { url: "/images/tata-start-sip.png", alt: "Start SIP Flow", caption: "SIP investment flow with step-up configuration and guided amount selection", type: "mobile" },
    ],
    problemDescription: "Wealth management platforms often require users to navigate complex financial information, investment journeys, compliance requirements, and operational workflows. The challenge was to create a seamless experience that simplified decision-making while preserving the depth, transparency, and trust expected from a premium wealth management platform.",
    painPoints: [
      { title: "Complex Investment Workflows", description: "Users faced intricate investment processes and financial terminology that created friction during onboarding and transactions." },
      { title: "Information Overload", description: "Information-heavy interfaces caused cognitive overload, making it difficult for users to find and act on key financial data." },
      { title: "Fragmented Journeys", description: "Wealth product and service journeys felt disconnected, forcing users to navigate across multiple touchpoints." },
      { title: "Compliance vs. Usability", description: "Balancing regulatory compliance requirements with an intuitive, approachable user experience proved challenging." },
    ],
    solutionDescription: "I designed and optimized end-to-end wealth management experiences focused on clarity, trust, and efficiency. By restructuring information architecture, simplifying critical workflows, and establishing scalable UI patterns, the platform became easier to navigate while supporting sophisticated financial decision-making.",
    solutions: [
      { title: "Simplified Investment Journeys", description: "I redesigned onboarding and investment flows — including SIP and one-time investments — to reduce steps and guide users with clear defaults." },
      { title: "Improved Information Hierarchy", description: "I restructured financial data presentation with scannable cards, progressive disclosure, and prioritized key metrics." },
      { title: "Scalable Design Patterns", description: "I built reusable UI components and patterns that maintain consistency across portfolio, fund details, and analysis screens." },
      { title: "Reduced Workflow Friction", description: "I streamlined action-heavy experiences like RM approvals, SIP step-ups, and fund switching with contextual quick actions." },
    ],
    techStack: [
      { name: "Figma", category: "design" },
      { name: "Miro", category: "design" },
      { name: "Jira", category: "integration" },
    ],
    projectOverview: "Tata Capital Wealth required a modernized digital experience capable of supporting both new and experienced investors while maintaining the trust and credibility associated with the Tata brand. As Product Designer, I focused on simplifying complex wealth management journeys without compromising the depth users expect.",
    projectGoals: "Primary Goal: Improve usability across wealth management journeys. Secondary Goals: Reduce friction in investment workflows, increase clarity of financial information, create scalable design foundations. Success Metrics: Workflow completion rates, user task efficiency, design system adoption.",
    researchDiscovery: "I conducted stakeholder interviews, workflow analysis, competitive benchmarking, and a comprehensive audit of the existing product. Research revealed that users were overwhelmed by dense financial interfaces and struggled to complete investment actions without guidance.",
    uxFlowWireframes: "I mapped end-to-end user journeys across portfolio management, fund discovery, and investment transactions. My wireframes focused on restructuring information architecture, optimizing multi-step workflows, and designing clear interaction patterns for financial data.",
    uiDesignComponents: "I created high-fidelity UI designs with responsive patterns aligned to a scalable design system. Key work included financial data visualization improvements, consistent card-based layouts, and refined typography hierarchy for premium fintech aesthetics.",
    outcomeResults: "I streamlined user workflows across portfolio, investment, and analysis experiences. Key actions became more discoverable, consistency improved across the platform, and a stronger design foundation was established for future product expansion.",
    whatILearned: "Financial products do not become easier by removing complexity. They become easier when complexity is organized, prioritized, and presented in a way that helps users make confident decisions.",
  },
  "meerolink": {
    id: "meerolink",
    title: "MeeroLink",
    category: "AgriTech / Operations Platform",
    description: "I designed a connected agricultural ecosystem — a farmer-facing mobile application and an internal operations dashboard that bridges field teams, farmers, and data-driven advisory services.",
    coverImage: "/images/meero-home-dashboard.png",
    date: "2025 - 2026",
    metrics: [],
    screenshots: [
      { url: "/images/meero-home-dashboard.png", alt: "Farmer Home Dashboard", caption: "Home dashboard with farm overview, weather, soil moisture, and mandi rates", type: "mobile" },
      { url: "/images/meero-your-farms.png", alt: "Your Farms", caption: "Farm management with crop health analytics, alerts, and activity timeline", type: "mobile" },
      { url: "/images/meero-soil-moisture.png", alt: "Soil Moisture Monitoring", caption: "Soil moisture sensors with live status, history graphs, and irrigation logs", type: "mobile" },
      { url: "/images/meero-meetag.png", alt: "meeTAG Produce Tracking", caption: "meeTAG platform for QR-based produce tracking and consumer engagement", type: "mobile" },
      { url: "/images/meero-advisory.png", alt: "Advisory Response", caption: "Advisory ticket with crop issue details, conversation thread, and issue snapshot", type: "mobile" },
      { url: "/images/meero-add-farm.png", alt: "Add Farm Flow", caption: "Multi-step farm onboarding with soil type, water source, and video upload", type: "mobile" },
      { url: "/images/meero-welcome.png", alt: "Welcome Onboarding", caption: "Onboarding experience introducing sensors, insights, and FPO connectivity", type: "mobile" },
      { url: "/images/meero-profile.png", alt: "Farmer Profile", caption: "Farmer profile with verification progress, certificates, and account management", type: "mobile" },
      { url: "/images/meero-desktop-dashboard.png", alt: "Operations Dashboard", caption: "Operations dashboard with key metrics, environmental impact, and farm analytics", type: "desktop" },
      { url: "/images/meero-desktop-moisture-sensors.png", alt: "Moisture Sensors Table", caption: "Moisture sensor observations with farmer data, sensor status, and filtering", type: "desktop" },
      { url: "/images/meero-desktop-moisture-filter.png", alt: "Irrigation Filter Modal", caption: "Advanced filtering for irrigation data with date range and category selection", type: "desktop" },
      { url: "/images/meero-desktop-farmer-profile.png", alt: "Farmer Profile Detail", caption: "Detailed farmer profile with farmblocks, soil moisture history, and irrigation data", type: "desktop" },
      { url: "/images/meero-desktop-farms-mapped.png", alt: "Farms Mapped", caption: "Geospatial farm mapping with sensor locations and overlay filters across India", type: "desktop" },
      { url: "/images/meero-desktop-meetag.png", alt: "meeTAG Analytics", caption: "meeTAG analytics with heatmap, scan trends, and location-based insights", type: "desktop" },
      { url: "/images/meero-desktop-advisory.png", alt: "Advisory Farmer Profile", caption: "Advisory workflow with crop observations, field attachments, and agronomist response", type: "desktop" },
      { url: "/images/meero-desktop-record-conversation.png", alt: "Record Conversation", caption: "Conversation recording modal with sensor context and agronomist response input", type: "desktop" },
    ],
    problemDescription: "Agricultural ecosystems involve multiple stakeholders, fragmented workflows, and varying levels of digital literacy. Farmers needed timely access to advisory services while internal teams required better operational visibility and coordination. The challenge was to create a unified experience that worked seamlessly for both groups.",
    painPoints: [
      { title: "High Advisory Drop-offs", description: "Users abandoned advisory journeys before completion due to friction in the flow and unclear next steps." },
      { title: "Diverse User Groups", description: "Farmers and field teams had vastly different digital literacy levels, requiring adaptable interface design." },
      { title: "Disconnected Communication", description: "Communication between farmers and internal teams was fragmented across channels without shared context." },
      { title: "Limited Operational Visibility", description: "Field teams lacked real-time visibility into farm activities, sensor data, and advisory ticket status." },
    ],
    solutionDescription: "I designed both a farmer-facing mobile application and an internal operations dashboard. The experience focused on simplifying advisory workflows, surfacing relevant actions, and improving coordination between farmers and internal teams.",
    solutions: [
      { title: "Redesigned Advisory Flow", description: "I restructured the advisory journey to reduce drop-offs with clearer steps, contextual issue snapshots, and streamlined response interfaces." },
      { title: "Mobile-First Farmer Experience", description: "I designed a mobile-first interface tailored for farmers with prioritized alerts, soil data, and mandi rate information." },
      { title: "Operations Dashboard", description: "I built a comprehensive dashboard for field teams with sensor monitoring, farmer profiles, farm mapping, and analytics." },
      { title: "Clear Action Prioritization", description: "I established information hierarchy that surfaces the right actions at the right moment for both farmers and operators." },
    ],
    techStack: [
      { name: "Figma", category: "design" },
      { name: "Miro", category: "design" },
    ...
    projectOverview: "MeeroLink was designed to bridge the gap between farmers and agricultural operations through a unified digital ecosystem. As Product Designer, I created both the farmer-facing mobile app and the internal operations dashboard to improve engagement, visibility, and decision-making.",
    projectGoals: "Primary Goal: Improve engagement with advisory services. Secondary Goals: Simplify critical workflows, support diverse user groups, improve operational efficiency. Success Metrics: Advisory completion rates, farmer engagement, operational response times.",
    researchDiscovery: "I conducted stakeholder interviews, workflow mapping sessions, user behavior observations, and requirement gathering workshops. Findings highlighted the need for relevance over volume — users needed the right information at the right moment, not more data.",
    uxFlowWireframes: "I redesigned advisory flows, mapped user journeys across farmer and operator personas, architected the dashboard information structure, and optimized multi-step workflows like farm onboarding and conversation recording.",
    uiDesignComponents: "I created mobile-first interface designs and a dashboard design system with responsive layouts. The visual language uses an agricultural green palette with card-based data presentation, clear status indicators, and accessible typography for diverse users.",
    outcomeResults: "I reduced friction in advisory journeys, improved clarity of key actions for both farmers and operators, enhanced operational visibility across farms and sensors, and created stronger alignment between user needs and business goals.",
    whatILearned: "Simplicity comes from prioritizing relevance. Users rarely need more information — they need the right information at the right moment.",
  },
  "inaam-application": {
