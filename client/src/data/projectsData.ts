...
export const projectsData: Project[] = [
  {
    ...
    description: "I redesigned wealth management experiences through simplified investment workflows and scalable design systems",
    icon: [
  ...
  },
  {
    ...
    description: "I designed a connected ecosystem for farmers and field teams through mobile and operations dashboard",
    icon: [
